\chapter{Appendix 2: Classification of PlacesNet Labels}
\label{chap:app2}
...
A detailed classification of the scene labels in to the four categories can be found in Table~\ref{tab:PlacesLabels}.
\begin{table}[htb!]
    \centering
